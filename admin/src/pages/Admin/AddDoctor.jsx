      ...
      <div className="bg-white px-8 py-8 border rounded-lg w-full max-w-5xl max-h-[80vh] overflow-y-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <div className="w-full lg:w-1/2 flex flex-col gap-4">
            <p className="text-lg font-semibold text-gray-700">Personal Information</p>
          ...
          <div className="w-full lg:w-1/2 flex flex-col gap-4">
            <p className="text-lg font-semibold text-gray-700">Professional Details</p>
            ...
            <div className="flex flex-col gap-2">
              ...
              <input onChange={(e) => setFees(e.target.value)} value={fees} className="border rounded px-3 py-2" type="number" placeholder="Fees (in USD)" required />
            </div>
          </div>
        </div>
        ...
        <div className="mt-5">
          <p className="text-lg font-semibold text-gray-700">About Doctor</p>
          <textarea
        ...
        {/* Submit Button */}
        <button type="submit" className="bg-primary px-10 py-3 mt-6 text-white rounded-full w-full lg:w-auto">
          Add Doctor
        </button>
      </div>
    </form>
